...
void main() {
  group('gg_parse_stdout_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_parse_stdout_version.dart');
